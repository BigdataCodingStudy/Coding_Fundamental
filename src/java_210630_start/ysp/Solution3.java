...
public class Solution3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("the answer is : "+s.solution("JEROEN"));
		System.out.println("the answer is : "+s.solution("JAN"));
		System.out.println("the answer is : "+s.solution("JAZ"));
		System.out.println("the answer is : "+s.solution("ABAAAAAAAAABB"));
		System.out.println("the answer is : "+s.solution("BAAABBAB"));
	}
}
